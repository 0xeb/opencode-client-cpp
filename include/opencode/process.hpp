...
// SPDX-License-Identifier: MIT
//
// Process management code adapted from copilot-sdk-cpp

#pragma once

/// @file process.hpp
/// @brief Cross-platform process management for OpenCode CLI
...
/// Find bun executable
/// @return Path to bun executable, or std::nullopt if not found
std::optional<std::string> find_bun();
